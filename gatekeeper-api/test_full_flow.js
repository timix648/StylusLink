...
const MY_DROP_ID = "395884"; // <--- REPLACE THIS WITH YOUR DROP ID
...
async function main() {
    ...
    try {
        // STEP 1: ASK THE AI JUDGE (Verify)
        ...
        // STEP 2: CLAIM THE DROP (Write to Chain)
        ...
        const claimRes = await axios.post(`${API_URL}/claim`, {
            ...
            receiver: MY_ADDRESS,
            biometricData: { 
                // We send empty data to trigger the "Mock Mode" we built in the server
                // This simulates a user clicking "Verify" without a real face scan
                mock: true 
            }
        });
